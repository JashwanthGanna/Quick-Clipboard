    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 bg-gradient-to-br from-slate-100 via-purple-50 to-slate-100 dark:from-slate-900 dark:via-purple-950 dark:to-slate-900 text-slate-900 dark:text-white transition-colors duration-300">
      ...
      <section className="pt-28 lg:pt-36 pb-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-slate-900 dark:text-white mb-4">Disclaimer</h1>
      ...
      <section className="pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="backdrop-blur-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl p-8 space-y-6 shadow-xl dark:shadow-none">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">General Disclaimer</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">No Guarantee of Availability</h2>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Content Responsibility</h2>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Data Loss</h2>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Security Limitations</h2>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Blog and Educational Content</h2>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Changes to This Disclaimer</h2>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
