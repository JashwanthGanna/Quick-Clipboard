          ...
          <div className="prose prose-invert prose-slate max-w-none space-y-8">
            ...
            <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 space-y-6">
              ...
              <div>
                ...
                <h3 className="text-lg font-semibold text-white mb-2">2.1 Clipboard Content</h3>
                ...
                <h3 className="text-lg font-semibold text-white mb-2 mt-4">2.3 Cookies</h3>
                <p className="text-slate-400 leading-relaxed">
              ...
              <div>
                ...
                <p className="text-slate-400 leading-relaxed mb-3">We use the information we collect to:</p>
                <ul className="list-disc list-inside text-slate-400 space-y-1 ml-4">
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-slate-400 space-y-1 ml-4 mt-2">
              ...
              <div>
                ...
                <p className="text-slate-400 leading-relaxed">
                  ...
                  <a href="mailto:privacy@quickclipboard.com" className="text-purple-400 hover:text-purple-300 underline">
